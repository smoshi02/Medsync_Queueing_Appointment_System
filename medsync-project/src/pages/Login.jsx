  ...
  return (
    <div className="min-h-screen flex items-center justify-center lg:justify-end relative overflow-hidden p-4 lg:pr-20">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-black/80 via-blue-950/75 to-black/80"></div>


        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#5996EC]/10 rounded-full blur-3xl animate-pulse"></div>
        <div
          className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-[#4785DB]/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="hidden lg:flex absolute left-0 top-0 bottom-0 w-1/2 flex-col justify-between p-16 z-10">
        ...
        <div className="grid grid-cols-2 gap-4 max-w-xl">
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all group">
            <div className="w-12 h-12 bg-[#5996EC]/20 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <svg className="w-6 h-6 text-[#5996EC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-10 border border-white/20">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="relative mb-4">
              <div className="absolute inset-0 bg-[#5996EC]/30 blur-2xl rounded-full"></div>
              <img src={logo} alt="MedSync" className="h-16 relative z-10" />
            </div>
            <h1 className="text-2xl font-bold bg-gradient-to-r from-[#5996EC] to-[#4785DB] bg-clip-text text-transparent">
              MedSync
            </h1>
            <p className="text-[#5996EC] text-sm font-medium mt-1">
              Healthcare Management System
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 rounded-xl
                    ...
                    ${usernameError
                      ...
                      : "border-slate-200 focus:border-[#5996EC] focus:ring-blue-100"
                    }
                  `}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-6 bg-gradient-to-r from-[#5996EC] to-[#4785DB]
                hover:from-[#4785DB] hover:to-[#3674CA] text-white py-3.5 rounded-xl
                font-semibold shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50
